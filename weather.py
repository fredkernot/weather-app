...
def read_user_cli_args():
    """Handles the CLI user interactions - Allows user to input arguments.
    ...
    parser.add_argument(
        ...
        "--imperial",
        action="store_true",
        help="diplay the temperature in imperial units",
    )
...
def build_weather_query(city_input, imperial=False):
    ...
    Args:
        ...
        imperial (bool): Whether or not to use imperial units fro temp
